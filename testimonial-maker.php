...
if ( ! class_exists( 'awl_testimonial' ) ) {
	class awl_testimonial {		
		...
		protected function _constants() {
			//Plugin Version
			define( 'PFG_PLUGIN_VER', '0.0.10' );
			
			//Plugin Text Domain
			define("TML_TXTDM","awl-testimonial" );

			//Plugin Name
			define( 'TML_PLUGIN_NAME', __( 'Testimonial', TML_TXTDM ) );
		...
		public function Testimonial() {
			$labels = array(
				'name'               => _x( 'Testimonial Maker', 'post type general name', 'TML_TXTDM' ),
				'singular_name'      => _x( 'Testimonial', 'post type singular name', 'TML_TXTDM' ),
				'menu_name'          => _x( 'Testimonial Maker', 'admin menu', 'your-plugin-textdomain' ),
				'name_admin_bar'     => _x( 'Testimonial', 'add new on admin bar', 'TML_TXTDM' ),
				'add_new'            => _x( 'Add New Testimonial',  'TML_TXTDM' ),
